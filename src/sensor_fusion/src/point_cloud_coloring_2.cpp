/*!
 * \file   point_cloud_coloring_2.cpp
 * \brief  Point Cloud Coloring Offile node CPP File
 *
 * \author Pedro Martins (martinspedro@ua.pt)
 *
 * WIP ROS node that operates offline, i.e., loads the bag file and runs the sensor fusion algorithm on it
 * \todo Finish node
 */
...
const std::string kitti_bags_folder_path = "/media/martinspedro/DATA/UA/Thesis/multiple-lidar-interference-mitigation/"
                                           "datasets/Kitti/";
