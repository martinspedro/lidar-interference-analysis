...
filename = constructFullPathToResults(sys.argv[1], GROUND_TRUTH_AVERAGE_POINT_DISTANCE_BIN_NAME)
...
hist_filename = constructFullPathToGraphics(sys.argv[1], GROUND_TRUTH_AVERAGE_POINT_DISTANCE_HIST_FILE_NAME)
...
colored_mesh_filename = constructFullPathToGraphics(sys.argv[1], GROUND_TRUTH_AVERAGE_POINT_DISTANCE_COLOR_MESH_FILE_NAME)
