...
colored_mesh_filename = datasets_path.constructFullPathToTestScenario(test_codename, datasets_path.INTERFERENCE_ROI_DISTANCE_ERRORS_COLOR_MESH_FILE_NAME)
...
for i in range(0, len(human_values), 1):
    ...
    filename = datasets_path.constructFullPathToResults(test_scenario, datasets_path.ROI_GROUND_TRUTH_BAG_POINTS_DISTANCE_VECTOR_BIN_NAME)
    f = open(filename, "rb")
    print(filename)
...
print("Done! Saving Colored Mesh Graph... "),
colored_mesh_filename = datasets_path.constructFullPathToTestScenario(test_codename, datasets_path.GROUND_TRUTH_ROI_DISTANCE_ERRORS_COLOR_MESH_FILE_NAME)
...
print("Done! Saving Colored Mesh Graph... "),
colored_mesh_filename = datasets_path.constructFullPathToTestScenario(test_codename, datasets_path.DIFFERENCE_ROI_DISTANCE_ERRORS_COLOR_MESH_FILE_NAME)
