...
filename = datasets_path.constructFullPathToResults(sys.argv[1], datasets_path.INTERFERENCE_BAG_POINTS_INTENSITY_VECTOR_BIN_NAME)

if len(sys.argv) == 3:
    number_of_bins = sys.argv[2]
else:
    number_of_bins = 100 # one bin per intensity
...
hist_filename = datasets_path.constructFullPathToGraphics(sys.argv[1], datasets_path.INTERFERENCE_BAG_INTENSITY_HIST_FILE_NAME)
