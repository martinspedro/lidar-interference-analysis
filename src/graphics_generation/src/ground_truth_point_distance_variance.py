...
filename = constructFullPathToResults(sys.argv[1], GROUND_TRUTH_POINT_DISTANCE_VARIANCE_BIN_NAME)
...
hist_filename = constructFullPathToGraphics(sys.argv[1], GROUND_TRUTH_POINT_DISTANCE_VARIANCE_HIST_FILE_NAME)
...
colored_mesh_filename = constructFullPathToGraphics(sys.argv[1], GROUND_TRUTH_POINT_DISTANCE_VARIANCE_COLOR_MESH_FILE_NAME)
