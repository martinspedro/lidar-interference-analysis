...
filename = constructFullPathToResults(sys.argv[1], GROUND_TRUTH_BAG_POINTS_INTENSITY_VECTOR_BIN_NAME)
...
hist_filename = constructFullPathToGraphics(sys.argv[1], GROUND_TRUTH_BAG_INTENSITY_HIST_FILE_NAME)
