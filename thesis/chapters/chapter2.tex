...
\end{figure}
For error estimation, algorithm x is used. \citeneeded
...
\begin{itemize}
	...
	\item \textbf{\acf{opencv}:} open source library for C++, Python and C that implements \acl{sota} algorithms on computer vision;
