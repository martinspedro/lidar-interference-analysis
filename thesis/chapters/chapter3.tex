...
Calibrating the camera and \ac{lidar}, as explained in section \ref{subsec:sota:camera-intrinisc-calibration},

The calibration between the camera and \ac{lidar} 
Intrinsic Camera Calibration can be made 
