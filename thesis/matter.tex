...
\usepackage{lscape}
%\usepackage[inkscape=yes, inkscapelatex=true]{svg}
...
\DeclareSIUnit{\revolutions}{revs}
\DeclareSIUnit[per-mode=symbol]{\revspersecond}{\revolutions\per\second}
...
%\chapterstyle{thesis} 
% Others: dowding, demo2, dash, chappell, brotherton, bianchi, ger, madsen, tatcher,
% veelo,indexes) thesis can also be used as defined previously
%
...
\newcommand{\sectionStyle}{\bfseries}%\MakeTextLowercase}
